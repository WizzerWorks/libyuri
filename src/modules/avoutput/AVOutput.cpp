...
void add_stream(StreamDescription *output_stream, AVFormatContext *fmt_ctx, const AVCodec **codec, enum AVCodecID codec_id, AVPixelFormat pixel_format = AV_PIX_FMT_NONE) {
